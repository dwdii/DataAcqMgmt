...
day of week, etc. Some of these transformations are applied in the code
...
bikes$segmentOfDay <- ifelse(bikes$hourOfDay >= 5 & bikes$hourOfDay < 12, 
                                       ...
                                       ifelse(bikes$hourOfDay >= 12 & bikes$hourOfDay < 17, 
                                              ...
                                              ifelse(bikes$hourOfDay >= 17 & bikes$hourOfDay < 22, 
                                                     3, 4)))
# 19
#bikes$segmentOfDayInt <- as.numeric(bikes$segmentOfDay) 
#levels(bikes$segmentOfDay)
```
...
g4 <- g4 + labs(title="Information Gain - Registered User Bike Shares by Partition", x="Paritioning Attribute", y="Information Gain")
g4
countEntMelt
```
